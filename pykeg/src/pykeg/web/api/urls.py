...
urlpatterns = patterns('pykeg.web.api.views',
    ...
    url(r'^payments/?$', 'all_payments'),
    url(r'^payments/(?P<payment_id>\d+)/?$', 'get_payment'),
    url(r'^coin-selectors/?$', 'all_coin_selectors'),
    url(r'^coin-selectors/(?P<selector_name>[^/]+)/?$', 'get_coin_selector'),
    url(r'^coin-selectors/(?P<selector_name>[^/]+)/logs/?$', 'get_coin_selector_logs'),
